...
# ---- DeepFilterNet: giß╗¢i hß║ín mß╗⌐c khß╗¡ nhiß╗àu tß╗æi ─æa ----
ATTEN_LIM_DB = 20.0

# ---- Envelope follower (theo d├╡i mß╗⌐c n─âng l╞░ß╗úng) ----
FRAME_MS = 50            # k├¡ch th╞░ß╗¢c khung ─æß╗â t├¡nh RMS

# ---- Mß╗⌐c mß╗Ñc ti├¬u chung cho to├án bß╗Ö file ----
TARGET_PERCENTILE = 50   

# ---- Ng╞░ß╗íng ph├ón biß╗çt tiß║┐ng n├│i vs im lß║╖ng/nhiß╗àu nß╗ün ----
NOISE_FLOOR_DB = -55.0  

# ---- Giß╗¢i hß║ín gain 2 chiß╗üu ----
MAX_GAIN_DB = 24.0       
MIN_GAIN_DB = -10.0      

# ---- L├ám m╞░ß╗út gain ─æß╗â tr├ính click/pumping ----
GAIN_SMOOTH_MS = 60      

# ---- Giß╗¢i hß║ín bi├¬n ─æß╗Ö cuß╗æi c├╣ng ─æß╗â tr├ính clipping sau khi khuß║┐ch ─æß║íi ----
OUTPUT_PEAK = 0.97
