...
setup_cells.append(code_cell([
    ...
    "subprocess.run([sys.executable, '-m', 'pip', 'install', '-q', 'huggingface_hub', 'addict', 'modelscope'], check=True)\n",
    "import os, re, shutil\n",
    "\n",
    "TARGET_DIR = '/kaggle/working/SpeakAI-Eval'\n",
...
run_cells.append(code_cell([
    ...
    "    'python-dotenv>=1.0.0', 'addict', 'modelscope',\n",
...
run_cells.append(code_cell([
    ...
    "\\n",
    "Yêu cầu định dạng (bằng tiếng Việt, Markdown đẹp, rõ ràng):\\n",
...
')\n",
    ...
    "        \n",
    "        # Không dùng Khử nhiễu & Cân bằng âm lượng (để đảm bảo đặc trưng gốc)\n",
    "            \n",
    ...
    "                    if k in ['accuracy', 'fluency', 'prosodic', 'score', 'completeness'] and isinstance(v, (int, float)) and v > 0:\n",
