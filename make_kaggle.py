...
run_cells.append(code_cell([
    ...
    "    \n",
    "    prompt = f\"\"\"Bạn là giáo viên phát âm.\\n",
    "Hãy nhận xét thật ngắn gọn (2-3 câu) về lượt nói này của Học viên.\\n",
    "Nếu phát âm tốt, đúng ngữ pháp, chỉ cần nói tốt.\\n",
    "Nếu sai, hãy hướng dẫn cách sửa gọn gàng nhất.\\n",
    "Sử dụng icon ✅ (nếu tốt) và ❌ (nếu có lỗi).\\n",
    "\\n",
    "Ngữ cảnh Giáo viên hỏi: {teacher_text}\\n",
    "Học viên trả lời: {student_text}\\n",
    "Điểm phát âm: {score:.1f}/10\\n",
    "Từ sai: {bad_words_str}\\n",
